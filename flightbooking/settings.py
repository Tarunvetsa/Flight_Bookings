...
SECRET_KEY = "django-insecure-82jwl%f_=ip#l0m+whvmfe@c!@dxza+fjqdb!doi$9lnhqa^+0"
...
AUTH_USER_MODEL='bookings.User' # To indicate our project to use app defined user model
